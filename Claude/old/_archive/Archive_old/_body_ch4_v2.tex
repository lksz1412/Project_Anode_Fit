...
dissipation 을 본 장에서 $\dot{\mathcal Q}_{\transp,n}$ 으로 분리했다. 즉 \textbf{Ch2 의
$\dot{\mathcal Q}_{\irr,n}\supset$ 본 장 $\dot{\mathcal Q}_{\irr,n}+\dot{\mathcal Q}_{\transp,n}$} 이며, 두
장의 항을 함께 쓸 때 transport dissipation 을 이중 계상하지 않는다(본 장 $\dot{\mathcal Q}_{\irr,n}$ 은
계면 반응/transition entropy production 만 포함).
