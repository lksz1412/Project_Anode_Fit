...
| AL-3 | 흑연 staging 전이($4\to3\to2L\to2\to1$), 관측 $N_p\approx3\sim4$ | GROUNDED | dahn1991, ohzuku1993, funabiki1999 | 10.1103/PhysRevB.44.9170; 10.1149/1.2220849; 10.1016/S0013-4686(99)00262-4 | Ch1 staging |
...
| AL-14 | ★ stretched tail = 지수 완화의 연속 합/분포 (kernel integral) — \emph{이 문서 핵심 물리} | GROUNDED | **johnston2006**, lindsey1980 | **10.1103/PhysRevB.74.184430**; 10.1063/1.440485 | Ch1 kernel (★macdonald2000 오귀속 대체) |
...
| AL-16 | non-uniqueness: stretched→$\rho_G$ 역매핑 비유일 (forward-only) | BOUNDED | plonka1998, baessler1993 | 10.1021/jp9831808 | Ch1 spectrum caveat |
...
| AL-61 | Plan A closure: Fredholm 2종 ratio-substitution (사용자 PhD) | BOUNDED | jcp2017, lee2011, son2013 | 10.1063/1.5000882; 10.1063/1.3568936; 10.1063/1.4802006 | Ch6 closure |
...
**★ macdonald2000 처리**: 오귀속(Phase 0.2 G-1)으로 \emph{제거}. AL-14 stretched-tail grounding = johnston2006(continuous sum of exponentials, 정확 대응) + lindsey1980(KWW). 만약 "고정 barrier 분포 → T-의존 stretched exponent" 의 \emph{정확한} 형태가 johnston/lindsey 로 완전히 닫히지 않으면 해당 세부는 Ch1 S2 에서 FLAGGED 후보로 재검토(방향-3).
