...
def xi_eq(Vn, Ud, w):
    """(1.21) 의 꼴 — M2. 중심은 분기 중심 U^d, 폭 w 는 S1 동결값
...
def ln_Lq(T, I_abs, Q_cell, dHa_eff, b, chi_d, A_d):
    ...
    chi_d: 방전이면 chi, 충전이면 1-chi — 같은 전이상태의 합-1 강제(1.15);
