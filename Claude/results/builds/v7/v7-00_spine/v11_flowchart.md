...
- 분극 부호 V_n = V_app − σ_d|I|R_n. ★**방전(탈리튬화·산화) 시 측정 V_app 가 평형측 V_n 보다 높다**(양의 anodic 과전압) — V_n 은 V_app 에서 분극을 뺀 값. 충전(리튬화·환원)은 반대(측정 V_app 가 더 낮음). [2026-06-29 정정: 직전 "관측 V 평형보다 낮음" 서술은 오류 — v7-05b 보완 에이전트 적발(DQ-b1), master 검산 후 정정.]
