...
| Phase E1 | 81-140 | — | spine | New spine redesign (Q_ext → continuous charge balance → ρ(μ; q, T) → V_n implicit → continuous reactivity → dQ/dV; discrete ξ_j demoted to derived) | (pending) | (above) | (pending) | (pending) | (pending) | (pending) | 141 |
