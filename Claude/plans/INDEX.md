...
## ★ 현재 활성 — v1.0.20 (계획·이력 위치가 본 폴더가 아님 — 사용자 2026-07-16 위치 규약)
| 파일 | 역할 | 상태 |
|---|---|---|
| **`../docs/v1.0.20/plans/2026-07-16-v1020-master-plan.md`** | ★MASTER — 이해 중간다리·서지 무결·컨벤션 통일 증판(P0~P8). 이 버전 한정: 계획 = `docs/v1.0.20/plans/`·이력 = `docs/v1.0.20/results/` | GO 대기 |

> 참고: v1.0.16~v1.0.19 마스터플랜(본 폴더 2026-07-06~07-08 파일들)은 완주 — 최신 완결 = `2026-07-08-v1019-ch1-fable-rewrite-plan.md`(v1.0.19, done).
