...
| **2.1** | 자산 지도 | 14–15 | 카운트 정의 고정(모집단 = 파일 집합 60 = 빌드 56 + 미포함 4 — v5.3) 후 재계수 = brief §4.2 전건 일치 · 마스터 3본 + 지원 4본 전문 정독(행 범위) · boxed 64 ID 표(라벨 부재 1 표시) · 빌드 포함/미포함 열 · 자산 태그 계열 확정 · G-금지 게이트 실물 수 · diff 3+3+hash · touch-up 4건 판정 · **v1.0.26A/B 자산 지도(DR-1 A+B)** · Phase Result | — | 본 §2.2 표·R4a §1·R4b §1·R2 §2.10 | 대기 |
