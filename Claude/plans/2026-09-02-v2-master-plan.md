...
> **실행 순서 재배열(v5.6 · 사용자 2026-09-11 "흑연 먼저 완성해서 내놓는 방식으로 진행")** — Phase·Step 삭제 없이 **실행 순서만** 바꾼다. **Ch1(흑연) 우선 경로** = 1.1~1.5 → 2.1 · 2.2 Step 16~18 · 2.3 Step 21 · 2.4/2.5(Ch1 몫) · 2.6 · 2.7 → 3.1~3.7(3.3 Step 43 제외) → 4.0~4.5 → 5.x·6.x(Ch1 한정) → **Ch1 PDF 산출·보고** → **이연분**(2.2 Step 19 · 2.3 Step 22 · 2.4/2.5 LCO·Si 몫 · 3.3 Step 43 · 4.6~4.8 · 5/6 잔여 · 챕터 7). cumulative Step 번호는 그대로(이연 Step 은 번호 유지·실행 시점만 뒤 · Step 파일은 실행 순으로 생성). 챕터 말 Phase Result(2.7·3.7·4.9·5.3·6.3)는 Ch1 한정판으로 먼저 저장하고 이연분 완료 시 Addendum(결과 보호 규범).
---
