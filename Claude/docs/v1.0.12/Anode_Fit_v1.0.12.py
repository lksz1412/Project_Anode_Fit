# -*- coding: utf-8 -*-
# ============================================================================
# ★ Anode_Fit  release 버전 = 1.0.12  — 문건 Ch1/Ch2 1.0.12 와 동일 버전·matched
#   (구현 계보: v11_final → use_w_eff 제거 → 1.0.10 → 1.0.12. 코드·문건 버전 통일.
#    1.0.12 = Fable 전수 재검 반영판 — 코드 물리 로직 무변경(감사 결함 0), 헤더·라벨 위생만.)
# ----------------------------------------------------------------------------
# Anode_Fit 흑연 음극 dQ/dV 물리 구현 — 1.0.12 (v11_final 기반 계보, 2026-07-02)
