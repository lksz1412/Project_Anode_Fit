...
\subsection{노드 대응 판정표}\label{ssec:si-map}
...
\bottomrule
\end{tabular}
\caption{골격 노드의 Si 대응 판정 --- 이월 2(N0·N9)·구조 이월 2(N5·N8)·재해석 3(N1·N2·N4)·부분
...
\subsection{미결 공백 GS-1 --- 기계 히스테리시스는 골격 밖 새 물리}\label{ssec:si-gap}
...
\subsection{부분 적용 시연의 자리 --- 실제 이산 전이 둘}\label{ssec:si-partial}
골격 문법이 Si 에서 그대로 시연 가능한 곳은 실제 이산 전이 둘뿐이다: (i) \textbf{1차 리튬화 두-상}
