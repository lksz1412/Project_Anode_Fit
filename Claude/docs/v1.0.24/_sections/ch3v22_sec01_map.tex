...
표시한 단 하나의 노드를 $\S\ref{sec:si-mech}$에서 다룬다. 곧 생존 지도는 이 장의 구성을 정하며, 흑연에서
...
N9 합산 & \textbf{이월} & $\bigstar$\,\S\ref{ssec:si-carry}. 전하 보존 반전(\eqref{eq:sm-mc-balance})이 격자 통계가 아니라 전하 회계에서 와, staging 이 무너져도 유지된다. \\
\bottomrule
\end{tabular}
...
정리한다. 곧 이 장 전체는 ``흑연에서 배운 것 중 무엇이 Si 에서도 성립하는가''라는 한 물음을 따라 전개된다.
