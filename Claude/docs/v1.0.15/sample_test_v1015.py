# -*- coding: utf-8 -*-
"""Anode_Fit v1.0.15 -- sample test figure (P4.4; English/ASCII labels only, glyph-safe).

Uses only v1.0.15 functions/classes (no re-implementation):
...
Output: sample_test_v1015.png (same folder, dpi=150). Deterministic (no RNG).
"""
...
CODE = r"D:\Projects\Project_Anode_Fit\Claude\docs\v1.0.15\Anode_Fit_v1.0.15.py"
OUT = r"D:\Projects\Project_Anode_Fit\Claude\docs\v1.0.15\sample_test_v1015.png"
spec = importlib.util.spec_from_file_location("anodefit", CODE)
m = importlib.util.module_from_spec(spec); spec.loader.exec_module(m)

# ---- instantiate v1.0.15 classes (representative parameters) ----
...
fig.suptitle("Anode_Fit v1.0.15 - sample test (graphite anode + LCO cathode + reversible heat)",
...
print("=== SAMPLE TEST v1.0.15 DONE ===")
