...
## ★기획 중 — v1.0.21 (확장판: 통계역학 2건·요동-응답·전역 항법 이원판·그림 반영·일반 top3·LCO 심화·Si Ch3 — 마스터 세션 단독 저작, 2026-07-17~)
> v1.0.20 동결 후 확장 전건 분리(사용자 결정 D-4). 결정 확정: D21-1 항법 적용판+미적용판 이원 빌드 / D21-2 일반 top3 / D21-3 Si 독립 Ch3 / D21-4 그림 보수 반영 / D21-5 요동-응답 포함 / D21-6′ **Fable 마스터 세션 단독 저작**(기존 경쟁 산출물 = 체리픽 재료). 재료 = v1.0.20 results 의 Q2/Q3 초안 12본·그림 31본·방향성 보고서 4본.

| 경로 | 1줄 요약 | 동의어 키워드 | 갱신일 |
|---|---|---|---|
| ../plans/2026-07-16-v1021-master-plan.md | ★MASTER — 5축(A 통계역학 GO 2건 / B 독자 인프라·항법 / C 일반 확장 / D LCO 심화 / E Si 신규 장), Q0~Q10 phase 표, D21 결정 이력 | 1.0.21, 마스터플랜, 대정준, TST, 항법, Si, LCO 심화, 단독 저작 | 2026-07-17 |
