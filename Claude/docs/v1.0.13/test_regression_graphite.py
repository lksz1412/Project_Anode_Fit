...
CODE = os.environ.get(
    "ANODEFIT_CODE",
    r"D:\Projects\Project_Anode_Fit\Claude\docs\v1.0.13\Anode_Fit_v1.0.13.py")
GOLD = r"D:\Projects\Project_Anode_Fit\Claude\docs\v1.0.13\golden_graphite_ref.npz"
