...
$\to\Omega_j$(단 깊은 2상측 $T_{c,j}\gg$창 이면 절편의 $T$-의존이 포화해 $\Omega_j$ \emph{하한}만 잡힌다 —
\S\ref{sec:falsify}(ii) regime 분기), 기울기$\to R_n$ 교차확인(식~\eqref{eq:hys_obsgap}). 각 단계가 앞 단계 기지값을 써 미지수를
