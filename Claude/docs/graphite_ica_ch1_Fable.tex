...
\begin{equation}
\frac{\dd Q}{\dd V}\Big|^{\dis}=C_\bg+\sum_j Q_j\,\frac{\dd\xi_{\eq,j}}{\dd V}\Big|_{U_j^\dis},\qquad
\frac{\dd Q}{\dd V}\Big|^{\chg}=C_\bg+\sum_j Q_j\,\frac{\dd\xi_{\eq,j}}{\dd V}\Big|_{U_j^\chg},
\label{eq:hys_dQdV}
\end{equation}
