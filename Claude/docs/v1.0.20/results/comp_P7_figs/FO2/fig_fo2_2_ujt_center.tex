...
\draw[->] (256,0.075) -- (345,0.075) node[right] {$T$ [K]};
...
% T_ref = 298.15 안내선
\draw[densely dotted,black!55] (298.15,0.075) -- (298.15,0.223);
\node[above,font=\tiny,black!55] at (298.15,0.223) {$T_\mathrm{ref}$};
...
\node[right,font=\tiny,align=left] at (341,0.0895) {$2\!\to\!1$\\$\Delta S{=}{-}16$: ${-}0.17$ mV/K};
\draw[black!45,line width=0.3pt] (340,0.07835) -- (340.8,0.0895);
% 앵커 라벨
