...
\node[font=\scriptsize,anchor=north] at (0.995,-0.03) {$\bar x$ (delithiation)};
...
\node[red,font=\scriptsize,anchor=west] at (0.555,-0.30) {step (wrong): 경계 $=\sum_kQ_k/Q$};
\draw[red,->,thin] (0.62,-0.272) -- (0.60,-0.185);
...
\node[black!50,font=\scriptsize,anchor=west] at (0.245,-0.048) {단순식~\eqref{eq:weighted} (중심값만)};
\draw[black!50,->,thin] (0.36,-0.068) -- (0.40,-0.114);
