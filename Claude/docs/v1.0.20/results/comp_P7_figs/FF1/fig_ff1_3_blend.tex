...
% ---- axes ----
\draw[->,>=Stealth] (-0.015,0) -- (1.045,0);
\node[font=\scriptsize,anchor=north] at (0.93,-0.10) {$\bar x$ (delithiation)};
...
\node[right,font=\tiny,black!60] at (1.048,0.301) {$\Delta S^0_{4\to3}/F=+0.301$};
\node[right,font=\tiny,black!60] at (1.048,0.055) {$\Delta S^0_{3\to2\mathrm L}/F=0$};
\node[right,font=\tiny,black!60] at (1.048,-0.052) {$\Delta S^0_{2\mathrm L\to2}/F=-0.052$};
\node[right,font=\tiny,black!60] at (1.048,-0.166) {$\Delta S^0_{2\to1}/F=-0.166$};
...
\node[red,font=\scriptsize,anchor=west] at (0.575,-0.315) {step (wrong): 경계 $=\sum_kQ_k/Q$};
...
% curve tags
\node[blue,font=\scriptsize,anchor=east,align=right] at (0.33,-0.385)
  {완전식~\eqref{eq:complete}\\(중심값 $+$ config)};
\draw[blue,->,thin] (0.245,-0.335) -- (0.175,-0.252);
\node[black!50,font=\scriptsize,anchor=west] at (0.56,-0.225) {단순식~\eqref{eq:weighted} (중심값만)};
\draw[black!50,->,thin] (0.60,-0.198) -- (0.625,-0.093);
...
\fill (0.50,-0.089) circle (1.2pt) node[above left,font=\tiny] {$-0.089$};
