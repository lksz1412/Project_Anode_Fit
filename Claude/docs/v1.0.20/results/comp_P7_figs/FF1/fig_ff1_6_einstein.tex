...
\draw[->] (100,0) -- (525,0) node[below,font=\scriptsize] {$T$ [K]};
...
% classical limit for 700 K
\draw[densely dotted,thick] plot[smooth] coordinates {(300,0.1527) (340,0.2779) (380,0.3891)
...
\node[font=\scriptsize,anchor=north west,align=left] at (317,0.132)
  {고전 극한 $R[1{+}\ln(T/\theta_E)]$\\($\theta_E{=}700$: 위에서 수렴)};
\draw[->,thin,black!60] (368,0.20) -- (392,0.385);
\node[font=\scriptsize,anchor=south west] at (105,0.02) {저온: $S_\vib\to0$ (동결)};
...
\draw[->] (255,-8.5) -- (364,-8.5) node[below,font=\scriptsize] {$T$ [K]};
...
\node[blue,font=\tiny,anchor=south west,align=left] at (256.5,9.7)
  {electronic $\propto T$ (강제 영점 없음;\\ 함수형 대조용 정규화 --- 크기 비교 아님)};
\draw[blue,->,thin] (274,9.55) -- (277,7.45);
% vib annotation
