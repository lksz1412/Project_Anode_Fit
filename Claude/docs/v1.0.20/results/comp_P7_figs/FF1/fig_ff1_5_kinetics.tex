...
% fate arrows
\draw[->,semithick] (0.55,-0.60) -- (0.25,-0.60);
\node[font=\tiny,anchor=south] at (0.40,-0.56) {$r<r^\ast$: 소멸};
...
\draw[->,thin,black!55] (0.50,-0.80) -- (0.635,-0.565);
% fastest mode marker
...
\node[font=\scriptsize,anchor=north] at (1.0,-0.035) {$k_c$};
