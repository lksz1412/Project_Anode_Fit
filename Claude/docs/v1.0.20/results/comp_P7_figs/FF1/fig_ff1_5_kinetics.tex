...
\foreach \xx in {0.5,1.5} {\draw (\xx,0.06) -- (\xx,-0.06) node[below,font=\scriptsize] {\xx};}
\draw (1,0.06) -- (1,-0.06);
...
\node[font=\scriptsize,anchor=east] at (0.88,2.85) {계면 $4\pi r^2\gamma$};
\draw[->,thin,black!60] (0.90,2.85) -- (0.975,2.87);
...
\node[font=\scriptsize,anchor=west,align=left] at (1.06,-2.30) {체적 $\tfrac43\pi r^3\Delta g_v$\\($\Delta g_v{<}0$)};
\draw[->,thin,black!60] (1.05,-2.42) -- (1.085,-2.56);
% total (thick)
...
\node[font=\scriptsize,anchor=north] at (1,-0.10) {$r^\ast$};
% fate arrows
\draw[->,semithick] (0.55,-0.88) -- (0.25,-0.88);
\node[font=\tiny,anchor=north] at (0.40,-0.96) {$r<r^\ast$: 소멸};
\draw[->,semithick] (1.30,1.42) -- (1.62,1.42);
\node[font=\tiny,anchor=south] at (1.46,1.47) {$r>r^\ast$: 성장};
...
\draw (0.5,0.012) -- (0.5,-0.012) node[below,font=\scriptsize] {0.5};
...
\node[font=\scriptsize,black!55,anchor=west,align=left] at (0.045,-0.72)
  {$f''>0$ (spinodal 밖):\\ 전-모드 감쇠 $R<0$};
\draw[->,thin,black!55] (0.615,-0.71) -- (0.66,-0.615);
% fastest mode marker
...
% band annotation
\node[font=\scriptsize,anchor=south] at (0.30,0.135) {성장 밴드};
\node[font=\scriptsize,anchor=north east] at (0.995,-0.045) {$k_c$};
