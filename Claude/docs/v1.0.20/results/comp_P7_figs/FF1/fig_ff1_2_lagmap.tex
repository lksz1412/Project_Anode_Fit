...
% ---- frame ----
\draw[->] (260,-10.8) -- (348,-10.8) node[right,font=\scriptsize] {$T$ [K]};
...
\node[font=\scriptsize,anchor=west] at (303,-1.16) {$w{=}RT/F$ ($23$--$29$ mV) --- 가시 꼬리 척도};
...
% bundle annotation (empty band between 80k curve and staging bundle)
\node[font=\scriptsize,align=left,anchor=north west] at (301,-4.9)
  {표~초기값 4전이 (C/10, $298$ K):\\ $L_V\!=\!5{\times}10^{-10}$--$5{\times}10^{-8}$ V $\ll w$\\
   $\Rightarrow$ 평형 종 전용(꼬리 비가시)};
\draw[->,thin,black!60] (300,-5.6) -- (294.5,-7.55);
...
\draw[<->,semithick] (326,-3.44) -- (326,-2.50);
\node[font=\tiny,anchor=east] at (325.2,-2.97) {$|I|{\times}10\Rightarrow L_V{\times}10$};
% temperature handle annotation
\node[font=\scriptsize,align=center] at (293,-3.85) {저온일수록 꼬리$\uparrow$\\(기울기 $\propto\Delta H_{a}^\eff$)};
\draw[->,semithick] (288.5,-3.25) -- (280.0,-2.05);
% crossing of w threshold
\fill (282.6,-1.615) circle (1.2pt);
\node[font=\tiny,anchor=east] at (281.6,-1.28) {$L_V\!\approx\!w$};
\draw[thin,black!60] (281.8,-1.36) -- (282.5,-1.56);
\end{tikzpicture}
