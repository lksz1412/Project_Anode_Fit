...
\node[font=\scriptsize,align=center] at (272,-4.55) {저온일수록 꼬리$\uparrow$\\(기울기 $\propto\Delta H_{a}^\eff$)};
\draw[->,semithick] (272,-3.9) -- (276.5,-2.55);
% crossing of w threshold
\fill (282.6,-1.615) circle (1.2pt);
\node[font=\tiny,anchor=north west] at (283.0,-1.75) {$L_V\!\approx\!w$};
\end{tikzpicture}
