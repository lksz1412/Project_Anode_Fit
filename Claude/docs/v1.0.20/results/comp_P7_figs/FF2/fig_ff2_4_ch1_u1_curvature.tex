...
\draw[-{Latex[length=1.6mm]}] (266,-33) -- (266,50)
  node[above,font=\scriptsize] {$U_1(T)-U_1(T_\mathrm{ref})$ [mV]};
\draw[-{Latex[length=1.6mm]}] (266,0) -- (354,0) node[below,font=\scriptsize] {$T$ [K]};
\foreach \xx in {270,290,310,330,350} {\draw (\xx,1.4) -- (\xx,-1.4) node[below,font=\scriptsize] {\xx};}
...
% identification gap at the high-T end
\draw[{Latex[length=1.3mm]}-{Latex[length=1.3mm]}] (350.5,41.46) -- (350.5,15.80);
\node[font=\tiny,anchor=west,align=left] at (351.3,28.6) {$-25.7$ mV};
\node[font=\tiny,anchor=east,align=right] at (347,37.5) {기저 선형\\($a_e{=}0$, $0.83$ mV/K)};
\node[font=\tiny,anchor=north west,align=left] at (322,5.6) {적분형 $T^2$ 곡률\\(식~\eqref{eq:U1T2}, $a_e{<}0$)};
\node[font=\scriptsize,anchor=north,align=center] at (310,-14) {고온 외삽이 선형보다\\\emph{낮아짐} $=$ 전자항 식별 신호};
\node[font=\scriptsize] at (310,-27.5) {(a)};
\end{scope}
% ============ (b) slope space: dU_1/dT(T) ============
\begin{scope}[xshift=7.9cm,x=0.055cm,y=4.6cm,shift={(-268.15,-0.16)}]
\draw[-{Latex[length=1.6mm]}] (266,0.16) -- (266,0.98)
  node[above,font=\scriptsize] {$\partial U_1/\partial T$ [mV/K]};
\draw[-{Latex[length=1.6mm]}] (266,0.16) -- (354,0.16) node[below,font=\scriptsize] {$T$ [K]};
...
\draw[densely dotted,black!55] (298.15,0.16) -- (298.15,0.93);
\node[font=\tiny,black!55,anchor=south] at (298.15,0.93) {$T_\mathrm{ref}$};
...
\draw[thick,densely dashed] (268.15,0.3557) -- (348.15,0.3557);
\node[font=\tiny,anchor=north west] at (269,0.345) {동결 근사: $(\Delta S_0{+}a_eT_\mathrm{ref})/F=0.356$ (상수)};
% full: linear in T
...
\node[font=\tiny,anchor=east] at (347.5,0.252) {$0.276$};
\node[font=\tiny,black!60,anchor=north] at (298.15,0.30) {$T_\mathrm{ref}$ 에서 동결 근사와 접함};
\node[font=\scriptsize] at (310,0.095) {(b)};
\end{scope}
\end{tikzpicture}
