...
\node[font=\scriptsize,anchor=west] at (3.24,-8.5) {★함정: 상수 대입 오답 $-\tfrac{4RT}{3F}u_j^3<0$ (비물리)};
...
\draw[densely dotted,black!60] (4.0,0) -- (4.0,54.76) -- (0,54.76);
\node[font=\tiny,anchor=north west,align=left] at (4.05,44) {$(4RT,\,54.8$ mV$)$\\$=2.131\,RT/F$};
% doping arrow toward threshold
\draw[-{Latex[length=1.6mm]},black!60] (3.05,39) to[bend right=14] (2.10,3.5);
\node[font=\scriptsize,anchor=west,black!60,align=left] at (2.42,44) {도핑: $\Omega^\mathrm{cat,dop}\!\to\!2RT^{+}$\\$\Rightarrow$ gap $\to0$};
\end{tikzpicture}
