...
\draw[-{Latex[length=1.5mm]}] (0,0) -- (1085,0)
...
\node[font=\scriptsize,anchor=west] at (240,1.42) {(a) 닫힌형, $\theta_E{=}700$ K};
\end{scope}
...
\node[font=\tiny,anchor=north west] at (300.5,-1.5) {$0$ ($T_\mathrm{ref}$ 강제 영점)};
...
\node[font=\scriptsize,anchor=west] at (322,-5.3) {(b) 기준온도 편차};
\node[font=\tiny,anchor=west,align=left] at (266,8.6)
