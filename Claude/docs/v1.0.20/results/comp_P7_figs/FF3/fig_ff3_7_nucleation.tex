...
\node[black!55,font=\tiny,anchor=west] at (0.585,1.44) {표면 비용 $+3(r/r^\ast)^2$};
...
\node[black!55,font=\tiny,anchor=west] at (0.60,-0.93) {부피 이득 $-2(r/r^\ast)^3$};
% total (thick)
...
\node[font=\tiny,anchor=west,align=left] at (1.12,-0.30)
  {$r>r^\ast$:\\성장};
\node[font=\scriptsize,anchor=west] at (0.04,1.62) {(a) 준안정 --- 핵생성 장벽};
\end{scope}
...
\node[font=\tiny,anchor=south] at (0.62,1.03) {$k_m=k_c/\sqrt2$};
\node[font=\tiny,anchor=west,align=left] at (0.06,0.86) {성장 밴드\\$0<k<k_c$ ($R>0$)};
\node[font=\tiny,anchor=west,align=left] at (0.86,-0.38) {$k>k_c$: 감쇠\\(구배 벌칙)};
