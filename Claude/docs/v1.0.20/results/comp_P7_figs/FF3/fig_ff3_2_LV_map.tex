...
\draw[-{Latex[length=1.6mm]}] (18,-13.3) -- (105,-13.3)
  node[below,font=\scriptsize] {$\Delta H_{a}$ [kJ/mol]};
...
\foreach \cx in {69.6,77.6,85.7} {\fill (\cx,-1.590) circle (1.1pt);
  \draw[densely dotted,black!55] (\cx,-1.590) -- (\cx,-13.3);}
\node[font=\tiny,anchor=north] at (69.6,-13.55) {$69.6$};
\node[font=\tiny,anchor=north] at (77.6,-13.55) {$77.6$};
\node[font=\tiny,anchor=north] at (85.7,-13.55) {$85.7$};
...
\node[font=\tiny,anchor=north,align=center] at (44,-9.8)
  {표~\ref{tab:staging} 초기값 창\\$\Delta H_a=40$--$48$};
% ---- C-rate arrow: L_V ∝ |I| ----
\draw[-{Latex[length=1.5mm]},thick] (60,-4.681) -- (60,-3.380);
\node[font=\tiny,anchor=west,align=left] at (61,-4.05)
