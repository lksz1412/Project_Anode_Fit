...
\draw[-{Latex[length=1.6mm]}] (-0.015,0) -- (1.13,0)
  node[below,font=\scriptsize] {$\bar x$ (탈리튬화 분율)};
...
\node[right,font=\tiny] at (1.005,0.301) {$\Delta S^0_{4\to3}/F{=}{+}0.301$};
\node[right,font=\tiny] at (1.005,0.055) {$\Delta S^0_{3\to2\mathrm L}/F{=}0$};
\node[right,font=\tiny] at (1.005,-0.052) {$\Delta S^0_{2\mathrm L\to2}/F{=}{-}0.052$};
\node[right,font=\tiny] at (1.005,-0.166) {$\Delta S^0_{2\to1}/F{=}{-}0.166$};
...
\node[black!45,font=\scriptsize,anchor=west] at (0.40,-0.205) {계단(오답)};
...
\node[font=\tiny,anchor=west] at (0.265,-0.235) {$(0.25,\,-0.204)$ --- \S\ref{ssec:worked} 예제점};
% ---- sign-flip tick of the full formula ----
\draw[densely dotted] (0.681,0) -- (0.681,-0.06);
\node[font=\tiny,anchor=north] at (0.681,-0.065) {부호 교대 $\bar x\!\approx\!0.68$};
% ---- exo/endo readouts ----
