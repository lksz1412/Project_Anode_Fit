...
스핀--통계 --- 의 양자 배경은 Chapter 1 §2 의 배경 박스(페르미온$\cdot$보손과 양자 통계)가 한자리에 정리했다.
...
유도의 전 단계 --- 정보 엔트로피 합에서 비열을 거쳐 $S_e$ 까지 --- 는 Chapter 1 §15(LCO 전자 엔트로피)의 전자
엔트로피 유도가 상술했고, 본 장은 그 결과를 분포 언어로 확장해 받는다. 식~\eqref{eq:Se-ch2} 의 $S_e$ 는 자리당
