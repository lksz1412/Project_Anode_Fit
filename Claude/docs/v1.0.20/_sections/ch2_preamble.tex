% ====================================================================
% ch2_preamble.tex — Chapter 2 (v1.0.20) 공통 preamble·매크로
%   graphite_ica_ch2_v1.0.20.tex 가 \input 한다. 절별 파일은 _sections/ 에.
...
\hypersetup{colorlinks=true, linkcolor=blue, urlcolor=blue, citecolor=blue,
  pdftitle={흑연 음극 dQ/dV — Chapter 2 (v1.0.20): 코인 하프셀 엔트로피·가역 발열의 통계열역학}}
\pagestyle{fancy}\fancyhf{}
\lhead{흑연 음극 $dQ/dV$ — Ch.2 (v1.0.20, 엔트로피 통계열역학)}\rhead{\thepage/\pageref{LastPage}}
