...
Level A(mobility) $\to$ Level B(directional barrier, $\beta_j\equiv\chi_j$) $\cdot$ Butler--Volmer 계층\\[0.2em]
...
★ $\chi_j\equiv\beta_j$ 동일물 명시(CHARTER step4) & 통과(\S 서, keybox, groundingbox) \\
