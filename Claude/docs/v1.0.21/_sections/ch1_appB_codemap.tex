...
문건과 구현의 연계는 단방향이다 --- 구현(\code{Anode\_Fit\_v1.0.19.py})의 주석$\cdot$docstring 이 본 문건의
...
$\bar x$ 진입점 & \code{solve\_U\_oc}(Chapter 2 전하 보존 음함수의 유일근 솔버)$\cdot$
...
additive --- 기존 $V_n$ 경로 무섭동; 요구명세는 Chapter 2 부록 B) \\
\bottomrule
\end{longtable}
\endgroup
