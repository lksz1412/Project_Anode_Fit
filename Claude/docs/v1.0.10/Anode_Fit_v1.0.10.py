# -*- coding: utf-8 -*-
# ============================================================================
# ★ Anode_Fit  release 버전 = 1.0.10  — 문건 Ch1 1.0.10(graphite_ica_ch1_v1.0.10) 과 동일 버전·matched
#   (구현 계보: v11_final → use_w_eff 제거 → 1.0.10. 코드·문건 버전 통일.)
# ----------------------------------------------------------------------------
# Anode_Fit 흑연 음극 dQ/dV 물리 구현 — 1.0.10 (v11_final 기반, 2026-07-01)
