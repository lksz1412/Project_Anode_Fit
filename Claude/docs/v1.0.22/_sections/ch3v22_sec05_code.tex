...
--- 대조 데이터는 $f_\mathrm{Si}$ 스윕 실측(\cite{gautam_blend2024}: 5--20$\cdot$\cite{moyassari_blend2022}: 0--20$\cdot$\cite{chatzogiannakis_blend2025}: 30 wt\%, tier-A --- $[0,0.30]$ wt\% 전 구간 커버).
