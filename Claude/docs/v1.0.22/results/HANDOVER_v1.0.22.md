...
| 2 | **"Part II 도입" 절 제목**(P5 보존) | 결정 대기 | `ch1_sec11_lcointro:4` — 역사 인계 chain, 개명/승격 여부(MERGE_READINESS §5-b·RV3 §5-1) |
| 3 | **moyassari_blend2022 등재** | 대기 | 검증 완료(DOI 10.1149/1945-7111/ac4545), 등재 시 G2 범위 강화(MERGE_READINESS §5-c) |
| 4 | **보류 풀 158+120건 선별 채택** | 대기 | 보완·수식화형 M 158 + L 전건 — 각 A##_REVIEW.md 에 완성 LaTeX 보존. 후속 phase 권고 |
