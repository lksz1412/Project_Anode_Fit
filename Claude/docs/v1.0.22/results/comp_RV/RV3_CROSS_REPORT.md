...
**● 중대(H) — 2건** (병합 대비 #1·#2 로도 재계상)
- RV3-B1 "Part II" 역사명 vs Chapter 2 신 구조(Ch1 내 sec00"Chapter 2" vs sec01"Part II" 자가상충·파트 순번 비선형).
- RV3-D1 tier 범례가 Ch2 단독 소재, Ch1 이 이를 사용·역참조 → Ch1 "본 장만으로 재현" 자기완결 위반("본서 전역" 선언 무실체).
