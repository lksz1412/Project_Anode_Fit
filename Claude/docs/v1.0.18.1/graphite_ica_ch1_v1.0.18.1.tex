...
%     코드 Anode_Fit 1.0.18.1 와 동일 버전·matched (계보 1.0.16→1.0.17→1.0.18.1; 헤더 아래 블록은 1.0.16 이력).
% --------------------------------------------------------------------
...
\hypersetup{colorlinks=true, linkcolor=blue, urlcolor=blue, citecolor=blue,
  pdftitle={흑연 음극 + LCO 양극 dQ/dV 이론: 계산 진행을 따라가는 수식-구동 (유도 확장) — Chapter 1 (v1.0.18.1)}}
\pagestyle{fancy}\fancyhf{}
\lhead{흑연 음극 + LCO 양극 $dQ/dV$ 이론 — Ch.1 (v1.0.18.1, 통계역학-first + 계산 진행)}\rhead{\thepage/\pageref{LastPage}}
...
% ====================================================================
문건과 구현의 연계는 단방향이다 --- 구현(\code{Anode\_Fit\_v1.0.18.1.py})의 주석$\cdot$docstring 이 본 문건의
