# -*- coding: utf-8 -*-
"""Anode_Fit v1.0.18.1 -- sample test figure (P4.4; English/ASCII labels only, glyph-safe).

Uses only v1.0.18.1 functions/classes (no re-implementation):
...
Output: sample_test_v1018_1.png (same folder, dpi=150). Deterministic (no RNG).
"""
...
OUT = r"D:\Projects\Project_Anode_Fit\Claude\docs\v1.0.18.1\sample_test_v1018_1.png"
spec = importlib.util.spec_from_file_location("anodefit", CODE)
m = importlib.util.module_from_spec(spec); spec.loader.exec_module(m)

# ---- instantiate v1.0.18.1 classes (representative parameters) ----
...
fig.suptitle("Anode_Fit v1.0.18.1 - sample test (graphite anode + LCO cathode + reversible heat)",
...
print("=== SAMPLE TEST v1.0.18.1 DONE ===")
