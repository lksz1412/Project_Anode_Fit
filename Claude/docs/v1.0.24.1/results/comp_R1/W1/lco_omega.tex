...
보존하려면($U(298)$ 불변 규약) $U{=}(-\Delta H{+}T\Delta S)/F$ 에서 $\dd\Delta H=T_\mathrm{ref}\,\dd\Delta S$ 라
엔탈피가 \emph{같은 부호로} $\Delta H_1\mapsto\Delta H_1\pm T_\mathrm{ref}\Delta S_e$ 로 재기준되어
