# -*- coding: utf-8 -*-
"""v1.0.24 자기일관 해법(부록 E) 하드 게이트 — ratio 보정·전달함수 옵션 검증.

★ 기존 test_gates_v1024.py(G1/G2/G3/R6)와 별개. 저 파일이 lag_ratio_correction=False(기본)에서
...
_s = importlib.util.spec_from_file_location("af1023", "Anode_Fit_v1.0.24.py")
