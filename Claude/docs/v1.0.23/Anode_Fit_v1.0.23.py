# -*- coding: utf-8 -*-
# ============================================================================
# ★ Anode_Fit  release 버전 = 1.0.23  — 문건 Ch1/Ch2 v1.0.23 와 동일 버전·matched
#    (물리·수치 경로는 1.0.21 확정본 승계·무변경; v1.0.23 은 부록 E 자기일관 옵션만 additive·기본 off)
...
#    1.0.21 = 문건 v1.0.21 부록 B(doc-leads 요구명세) 정합 이월 — B.1 x̄ 진입점 3종·B.3 θ_E 하위호환·ch1 부록 B n_j(T)=n_j+n_T1(T−T_ref) 선형 잔여 전부 v1.0.19 승계, 물리·수치 경로 무변경. 회귀 기준 B.2(74.4 mV·−0.204/−0.134/−0.070 mV/K·round-trip·5점 표·파생 A 175점)·G1 하위호환·G3 θ_E bit-exact 는 test_gates_v1023.py 로 전건 수치 재증빙.)
# ----------------------------------------------------------------------------
