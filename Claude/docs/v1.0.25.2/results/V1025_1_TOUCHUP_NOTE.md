...
| # | 항목 | 담당 |
|---|---|---|
| ~~빌드~~ | ✅ **완료(2026-07-26, 이 PC MiKTeX 25.12 XeLaTeX)** — ch1→ch2→ch3 3-pass+xr 재빌드, **오류 0·undefined ref/cite 0·102/30/22p**·대형 overfull 0. touch-up 4줄이 조판 무해 확인. PDF 3종 커밋 | (해소) |
