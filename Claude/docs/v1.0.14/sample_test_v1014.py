# -*- coding: utf-8 -*-
"""Anode_Fit v1.0.14 -- sample test figure (P4.4; English/ASCII labels only, glyph-safe).

Uses only v1.0.14 functions/classes (no re-implementation):
...
Output: sample_test_v1014.png (same folder, dpi=150). Deterministic (no RNG).
"""
...
CODE = r"D:\Projects\Project_Anode_Fit\Claude\docs\v1.0.14\Anode_Fit_v1.0.14.py"
OUT = r"D:\Projects\Project_Anode_Fit\Claude\docs\v1.0.14\sample_test_v1014.png"
spec = importlib.util.spec_from_file_location("anodefit", CODE)
m = importlib.util.module_from_spec(spec); spec.loader.exec_module(m)

# ---- instantiate v1.0.14 classes (representative parameters) ----
...
fig.suptitle("Anode_Fit v1.0.14 - sample test (graphite anode + LCO cathode + reversible heat)",
...
print("=== SAMPLE TEST v1.0.14 DONE ===")
