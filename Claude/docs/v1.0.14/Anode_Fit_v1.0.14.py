# -*- coding: utf-8 -*-
# ============================================================================
# ★ Anode_Fit  release 버전 = 1.0.14  — 문건 Ch1/Ch2 1.0.14 와 동일 버전·matched
#   (구현 계보: v11_final → use_w_eff 제거 → 1.0.10 → 1.0.12 → 1.0.13 → 1.0.14. 코드·문건 버전 통일.
#    1.0.13 = 통계역학-first 재구조화(Part 0/I/II) 동반판. 1.0.14 = 어투·엄밀성·Appendix 개정 동반판(물리 로직 승계).)
# ----------------------------------------------------------------------------
# Anode_Fit 흑연 음극 dQ/dV 물리 구현 — 1.0.14 (v11_final 기반 계보, 2026-07-04)
...
#
#   [근거 문건] graphite_ica_ch1_v1.0.14.tex(+ch2) — 커브식 명세(계보 원천 Opus_v6). 본 구현이 따르는 식:
