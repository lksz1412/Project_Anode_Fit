...
cm$^3$/mol $=3.19\times10^{-5}$ m$^3$/mol 이고($\rho_\mathrm{graphite}=2.26$ g/cm$^3$ 는 표준 물성값),
...
\end{scope}
\end{tikzpicture}
\caption{인과 꼬리의 방향. 점선 $=$ 평형 종($\xi_\eq(1-\xi_\eq)/w$, 방향 불변). 실선 $=$ peak\_shape
...
정합 목표. 전위 anchor: $4\!\to\!3$($0.210$ V)$\cdot$$2\!\to\!1$($0.085$ V)는 Dahn\cite{dahn1991},
$3\!\to\!2\mathrm L$$\cdot$$2\mathrm L\!\to\!2$($0.120$ V)는 Ohzuku 등\cite{ohzuku1993} 의 보고값과
정합(2차 출처 경유 확인 — 문헌 간 $5$--$15$ mV 시료 의존 편차 존재). $\Delta S_\rxn$ 의 부호$\cdot$수십
