...
$\delta U_\mathrm{PSD}\approx0.9$ mV 로 결론(실측 폭 대비 수 \% 미만)은 불변이다. \emph{동역학 채널}:
...
필요하다\footnote{$L_V$ 를 최적화 도구로 피팅할 때 $L_V$ 가 이 문턱을 지나면 목적함수가 $\sim23\%$ 점프해 landscape 가
비평활해진다.}), 꼬리식 자신의 $L_V\to0$ 소멸
...
정합 목표. 전위 anchor: $4\!\to\!3$($0.210$ V)$\cdot$$2\!\to\!1$($0.085$ V)는 Dahn\cite{dahn1991} 의
보고값과 정합, $2\mathrm L\!\to\!2$($0.120$ V)는 Ohzuku 등\cite{ohzuku1993} 의 보고값과 정합(모두 2차
출처 경유 확인), $3\!\to\!2\mathrm L$($0.140$ V)는 Ohzuku 보고 $\approx0.125$ V 와 $15$ mV 시료 의존
