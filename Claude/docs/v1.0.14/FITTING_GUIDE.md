...
| 4 (다온도) | dS_rxn, dS_a | 공통 | 표 | — | — | 부호 문헌일치; ★dS_rxn 은 (ΔH_rxn,ΔS_rxn) 서식 전이에서만 발효 — 'U' 서식에 dS_rxn 만 얹으면 **silent 무시**(dS_eff=0). 다온도 진입 전 전 전이를 (ΔH,ΔS) 서식으로 전환 | 다온도 | 피팅 |
