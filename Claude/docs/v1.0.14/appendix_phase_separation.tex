...
binodal 이 바깥, spinodal 이 안쪽에 놓인다(그림~\ref{fig:app-phasediag} 의 상평형도 --- $\Omega=3RT$
등온선의 네 교점이 그림~\ref{fig:app-tangent} 의 $\xi_b^\pm,\xi_s^\pm$ 과 같은 값이다). 이는 두 판정의 논리적 포함 관계의 기하적 표현이다:
