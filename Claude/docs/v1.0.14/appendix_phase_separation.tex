...
부피는 자유에너지를 낮추지만($\Delta g_v<0$ — 앞 절들의 몰당 분해 이득을 부피당으로 환산한 구동력
$\Delta g_v\simeq\Delta f_\mathrm{sep}/v_m$, $v_m$ = 몰부피) 모상과의 계면은 계면 에너지
...
binodal 접점에서 $\Delta f_\mathrm{sep}\to0$(\S\ref{app:chord} 의 박스)이라 그 근처에서
