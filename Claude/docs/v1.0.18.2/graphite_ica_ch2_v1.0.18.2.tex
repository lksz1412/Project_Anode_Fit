...
\label{eq:dSvib}
\end{equation}
이를 종합식~\eqref{eq:complete} 의 $\Delta S^0_j$ 자리에 가산해 $\Delta S_{\eff,j}(T)=\Delta S^0_j+\Delta S_\vib(T)$
...
식~\eqref{eq:dUvib} 의 미분을 셈하면 $T=278,\,298,\,318,\,348$~K 에서 각각 $\partial\Delta U_\vib/\partial T\approx
