% ====================================================================
% graphite_ica_consolidated_ch2.tex — 합류 Chapter 2 (발열 연결, v2 원본 밀도)
%   트렁크 = (B) 전하보존 6장 Ch2 전문 밀도. G1 Chapter 1
%   (graphite_ica_consolidated_ch1_G1.tex) 의 상태변수/기호 위에 적층.
%   Ch1 v2 정합: Θ(aggregate), k_j=k_phys, Level A/B, V_n,drive, GS/AL/FLAGGED/BOUNDED.
...
\hypersetup{colorlinks=true, linkcolor=blue, urlcolor=blue, citecolor=blue,
  pdftitle={Graphite ICA tail — 합류 Chapter 2 (발열, v2)}}
\pagestyle{fancy}\fancyhf{}
\lhead{흑연 음극 ICA tail — 합류 Chapter 2 (발열, v2)}\rhead{\thepage/\pageref{LastPage}}
...
\title{\textbf{리튬이온전지 흑연 음극 ICA tail 이론 — 합류 Chapter 2}\\[0.4em]
\large 발열 연결: 평형 전위 온도계수 $\cdot$ 열원 물리 분해 $\cdot$\\
가역/비가역 열의 entropy/affinity 기반 (Ch1 상태변수 위의 열 계층)}
