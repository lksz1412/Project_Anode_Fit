% ====================================================================
% graphite_ica_ch2_v1.0.16.tex — Chapter 2 (release 1.0.16; 계보 1.0.15 승계 — Fable 전수 재검 반영 —
...
\hypersetup{colorlinks=true, linkcolor=blue, urlcolor=blue, citecolor=blue,
  pdftitle={흑연 음극 dQ/dV — Chapter 2 (v1.0.16): 코인 하프셀 엔트로피·가역 발열의 통계열역학}}
\pagestyle{fancy}\fancyhf{}
\lhead{흑연 음극 $dQ/dV$ — Ch.2 (v1.0.16, 엔트로피 통계열역학)}\rhead{\thepage/\pageref{LastPage}}
...
끝까지 따라간다 --- 코드(\texttt{Anode\_Fit\_v1.0.16})가 내는 값 그대로다. 대표점은 탈리튬화 분율 $\bar x=0.25$
...
\bibitem{numverif2026} 본 연구 내부 수치 검증(Derivative A), \texttt{Anode\_Fit\_v1.0.16} 4-전이 흑연 staging 파라미터, 유한차분 vs.\ 가중식 비교 (2026). [내부 자료 — 표시 정밀도 일치 PASS, 본문 \S\ref{ssec:overlap} 요지.]
\end{thebibliography}
