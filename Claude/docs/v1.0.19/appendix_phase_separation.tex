...
%   v1.0.19 승계 — 내용 미개정, 본문(Ch1 v1.0.19) 절번호 텍스트 참조만 갱신
...
\author{}
\date{\normalsize 버전 1.0.18.2 초안\thanks{v1.0.19 승계 --- 본 부록은 v1.0.19 에서 내용 미개정으로 승계되며, 본문(Chapter 1 v1.0.19) 절번호 참조만 재작성판 번호로 갱신되었다.} \quad(본문 편입 여부는 검토 후 결정)}

\begin{document}
\maketitle

본문 Part 0(\S2)은 정규 용액(regular solution)의 자유에너지가 $\Omega_j>2RT$ 에서 볼록성을 잃는다는
