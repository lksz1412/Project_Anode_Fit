...
% ====================================================================
\section{두-상 broadening --- 평형 델타가 실측 종이 되는 까닭과 폭 $w_j$ 의 지위}\label{sec:broadening}
...
②$\otimes$③ 을 한꺼번에 흡수하고(두 몫의 분리는 $\sigma_\eta$ 의 독립 측정 없이는 비유일 --- (ii) 의
...
식~\eqref{eq:gibbsthomson} 수치 유도 --- 본문 (i)) 모델은 $\rho(U_\app)$ 역산$\cdot$PSD 크기 convolution
