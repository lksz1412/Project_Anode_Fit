% ====================================================================
% 서지 (13 외부 문헌 + 내부자료 numverif2026 = 14 bibitem)
% ====================================================================
...
\bibitem{numverif2026} 본 연구 내부 수치 검증(Derivative A), \code{Anode\_Fit\_v1.0.18.2} 4-전이 흑연 staging 파라미터, 유한차분 vs.\ 가중식 비교 (2026). [내부 자료 --- 표시 정밀도 일치 확인, 본문 \S\ref{ssec:overlap}$\cdot$\S\ref{ssec:blend} 요지.]
\end{thebibliography}
