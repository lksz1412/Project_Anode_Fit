% ====================================================================
% ch1_preamble.tex — Chapter 1 (v1.0.19) 공통 preamble·매크로
%   graphite_ica_ch1_v1.0.19.tex 가 \input 한다. 절별 파일은 _sections/ 에.
...
\hypersetup{colorlinks=true, linkcolor=blue, urlcolor=blue, citecolor=blue,
  pdftitle={흑연 음극 + LCO 양극 dQ/dV 이론: 계산 진행을 따라가는 수식-구동 (전면 재작성) — Chapter 1 (v1.0.19)}}
\pagestyle{fancy}\fancyhf{}
\lhead{흑연 음극 + LCO 양극 $dQ/dV$ 이론 — Ch.1 (v1.0.19, 통계역학-first + 계산 진행)}\rhead{\thepage/\pageref{LastPage}}
