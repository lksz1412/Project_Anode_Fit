...
\item Plan A와 Plan B가 같은 limiting cases를 주지 않으면, Chapter 1의 core 논리로는 Plan B
  formulation만 채택한다.
\item 이 dual hierarchy는 coding Plan B이 아니라 논리적 책임 분리다.
\end{enumerate}
...
% ====================================================================
\textbf{Deliverable.} ICA tail 의 논리식 (평가 순서 inner$\to$outer):
...
\item ★ 관측 tail = spectrum kernel integral (S9); closure = \textbf{Plan B (reduced-theory
  core, 항상 보존) + Plan A (Refs 6/7 instantiated analytic closure, M1-M5+$\varepsilon$ gated) +
