...
임의 clip/cap/softplus/step 정의식 0(GS-4). numerical-validation 구현은 본 장의 이론 범위 밖으로 둔다.
...
\item 온도 되먹임 시간 적분기$\cdot$root-find 절차$\cdot$수렴 판정은 별도 numerical implementation 문서의 대상이다.
\end{enumerate}
