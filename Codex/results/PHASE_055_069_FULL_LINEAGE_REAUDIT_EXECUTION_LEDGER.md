...
| 058 | 26–32 | 26.1 | lineage A | v1.0.10–v1.0.13 재감사 | IN_PROGRESS | `Codex/plans/2026-07-28-phase058-v1010-v1013-lineage-detailed-plan.md` | `Codex/results/PHASE_058A_AUDIT_QUEUE_RESULT.md` | 56-path/45-blob queue, initial text coverage | `PASS_P058_AUDIT_QUEUE`; 27 text blobs/13,757 lines/61 chunks | pending `PASS_P058_LINEAGE_A` | 26.2 |
