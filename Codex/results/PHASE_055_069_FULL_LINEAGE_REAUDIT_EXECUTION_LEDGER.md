...
| 058 | 26–32 | 26.1–26.5, 27.1–27.5, 28.1–28.3, 29.1–29.4, 30.1–30.3, 31.1–31.4 | lineage A | v1.0.10–v1.0.13 재감사 | IN_PROGRESS | `Codex/plans/2026-07-28-phase058-v1010-v1013-lineage-detailed-plan.md` | source/execution/probe/data + PDF/image/genealogy review | prior artifacts + PDF/image/genealogy + coordinate/kinetic/heat/report/copy/patch/R1/statmech/width-semantics/exact-patch/closure derivations | v1.0.13 has real ideal-core pedagogy but not closure: Ch1 50 pages/215 code mentions, 129 outside generous implementation boundary, 20 closure dimensions, no public data or Si; 35/35 statmech, 47/47 width, 87/87 patch and 84/84 closure checks PASS | pending `PASS_P058_LINEAGE_A` | 32.1 |
