...
| 057 | 18–25 | 18.1–18.6, 19.1–22.6 | intent | 사용자 의도·금지·결정 계보 복원 | IN_PROGRESS | `Codex/plans/2026-07-28-phase057-user-intent-recovery-detailed-plan.md` | `Codex/results/PHASE_057BG_DIRECTION_DECISION_GENEALOGY_RESULT.md` | coverage/Git/claim/actor ledgers, current direction register, decision genealogy | `PASS_P057_DIRECTION_GENEALOGY`: 22 decisions, 72 path+line+commit evidence links; 14 preserve/5 correct/1 empirical/1 theory-only/1 reject | pending `PASS_P057_INTENT_RECOVERY` | 23.1 |
