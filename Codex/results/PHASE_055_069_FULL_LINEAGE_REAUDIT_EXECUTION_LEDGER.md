...
| 057 | 18–25 | 18.1–18.6, 19.1–21.5 | intent | 사용자 의도·금지·결정 계보 복원 | IN_PROGRESS | `Codex/plans/2026-07-28-phase057-user-intent-recovery-detailed-plan.md` | `Codex/results/PHASE_057BF_ACTOR_AND_APPROVAL_SEPARATION_RESULT.md` | coverage, Git/claim/effectivity ledgers, provisional finding actor ledger, current direction register | `PASS_P057_ACTOR_SEPARATION`: 404 findings continuous; record/referenced actor separated; 17 direct-current directions; open/stale states recorded | pending `PASS_P057_INTENT_RECOVERY` | 22.1 |
