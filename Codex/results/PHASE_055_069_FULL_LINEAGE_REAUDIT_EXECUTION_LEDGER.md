...
| 056 | 9–17 | — | inventory | 전체 file/blob manifest와 read queue | PENDING | same master plan | pending | source manifest, read coverage | 미실행 | `PASS_P056_COMPLETE_MANIFEST` | 9 |
| 057 | 18–25 | — | intent | 사용자 의도·금지·결정 계보 복원 | PENDING | same master plan | pending | decision genealogy | 미실행 | `PASS_P057_INTENT_RECOVERY` | 18 |
