...
| 058 | 26–32 | 26.1–26.5, 27.1–27.5, 28.1–28.3, 29.1–29.4, 30.1–30.3, 31.1–31.3 | lineage A | v1.0.10–v1.0.13 재감사 | IN_PROGRESS | `Codex/plans/2026-07-28-phase058-v1010-v1013-lineage-detailed-plan.md` | source/execution/probe/data + PDF/image/genealogy review | prior artifacts + PDF/image/genealogy + coordinate/kinetic/heat/report/copy/patch/R1/statmech/width-semantics/exact-patch derivations | ideal chain preserved; current n classified as empirical width ratio; v1.0.13 exact patch 1,890+/1,268−, three changed callables, scalar guard and LCO direction fix preserved, LCO defaults unverified; 35/35 statmech, 47/47 width and 87/87 patch checks PASS | pending `PASS_P058_LINEAGE_A` | 31.4 |
