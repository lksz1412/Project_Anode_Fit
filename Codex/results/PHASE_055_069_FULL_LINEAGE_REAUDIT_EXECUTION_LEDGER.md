...
| 058 | 26–32 | 26.1–26.5, 27.1–27.4 | lineage A | v1.0.10–v1.0.13 재감사 | IN_PROGRESS | `Codex/plans/2026-07-28-phase058-v1010-v1013-lineage-detailed-plan.md` | source reviews + isolated execution + independent probes | queue; theory/code/test matrices; coverage; isolated execution; independent probe JSON | text and execution disposed; equilibrium/heat identities preserve; default current invariance, direct-\(L_V\) zero-current violation, 3600 unit blocker, stateless hysteresis, heat-sign contract confirmed; NPZ/PDF/image pending | pending `PASS_P058_LINEAGE_A` | 27.5 |
