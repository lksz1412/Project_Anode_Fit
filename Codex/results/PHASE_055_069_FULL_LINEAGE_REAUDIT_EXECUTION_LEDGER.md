...
| 058 | 26–32 | 26.1–26.5, 27.1–27.3 | lineage A | v1.0.10–v1.0.13 재감사 | IN_PROGRESS | `Codex/plans/2026-07-28-phase058-v1010-v1013-lineage-detailed-plan.md` | theory/code/test/demo/guide/handover reviews + isolated execution | queue; theory matrices; code behavior; test/demo claim matrix; full-text coverage; isolated execution JSON | 27/27 text blobs COMPLETE; 11/11 execution cases disposed; 9 report-only, v1.0.10 golden missing, v1.0.13 bit-exact FAIL at max \(2.665\times10^{-15}\); probe/PDF/image/data pending | pending `PASS_P058_LINEAGE_A` | 27.4 |
