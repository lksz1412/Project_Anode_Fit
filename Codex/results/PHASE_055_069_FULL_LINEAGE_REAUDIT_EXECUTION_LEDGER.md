...
| 058 | 26–32 | 26.1–26.5, 27.1–27.5, 28.1–28.3, 29.1–29.4, 30.1 | lineage A | v1.0.10–v1.0.13 재감사 | IN_PROGRESS | `Codex/plans/2026-07-28-phase058-v1010-v1013-lineage-detailed-plan.md` | source/execution/probe/data + PDF/image/genealogy review | prior artifacts + PDF/image/genealogy + coordinate/kinetic/heat/report/copy-lineage derivations | v1.0.11 paired text 8/8, 3,965 lines byte-identical and PDF 48/48 pages render-identical; scientific source/code/test change 0; v1.0.12 patch adjudication pending | pending `PASS_P058_LINEAGE_A` | 30.2 |
