...
| 058 | 26–32 | 26.1–26.5, 27.1–27.2 | lineage A | v1.0.10–v1.0.13 재감사 | IN_PROGRESS | `Codex/plans/2026-07-28-phase058-v1010-v1013-lineage-detailed-plan.md` | theory/code/test/demo/guide/handover source reviews | queue; theory equation/symbol/diff matrices; code behavior matrix; test/demo claim matrix; full-text coverage | `PASS_P058_AUDIT_QUEUE`; 27/27 text blobs, 13,757/13,757 lines COMPLETE; 11 Python test/demo assert count 0; execution/probe/PDF/image/data verdict pending | pending `PASS_P058_LINEAGE_A` | 27.3 |
