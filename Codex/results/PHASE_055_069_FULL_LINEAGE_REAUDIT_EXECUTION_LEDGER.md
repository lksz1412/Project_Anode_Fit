...
| 058 | 26–32 | 26.1–26.5, 27.1–27.5, 28.1–28.3, 29.1–29.3 | lineage A | v1.0.10–v1.0.13 재감사 | IN_PROGRESS | `Codex/plans/2026-07-28-phase058-v1010-v1013-lineage-detailed-plan.md` | source/execution/probe/data + PDF/image/genealogy review | prior artifacts + PDF/image/genealogy + coordinate/kinetic/heat derivations | heat identity retained with sign contract; width–entropy mismatch, negative irreversible output, electronic-gate sum-rule conflict, missing T² and rate/doping/high-voltage LCO closure recorded; prior-report adjudication pending | pending `PASS_P058_LINEAGE_A` | 29.4 |
